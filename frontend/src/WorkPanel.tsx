...
export function WorkPanel({ summary, status, syncing, canSync, onSync, onOpenMap, diff, earlierRunIds, onReviewDiff, workspaceId, gitStatus, gitDisabled, onGitChanged }: Props) {
  return <>
